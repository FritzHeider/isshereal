...
export function ToolsSection() {
  return (
    <section id="tools" className="py-24 bg-slate-50 dark:bg-slate-950/60 border-t border-slate-100 dark:border-slate-800">
      <div className="container-x">
        <div className="max-w-3xl mb-16">
          ...
          <p className="text-base sm:text-lg text-slate-600 dark:text-slate-400 mt-3.5">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {TOOLS.map((tool) => (
            <div
              key={tool.id}
              className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-6 flex flex-col justify-between hover:shadow-lg hover:border-emerald-300 transition-all duration-300 group"
            >
              <div>
                ...
                <h3 className="font-bold text-lg text-slate-900 dark:text-slate-100 group-hover:text-emerald-700 transition-colors">
                  {tool.title}
                </h3>
